-- DROP FUNCTION concat_locality (cocid VARCHAR);

CREATE OR REPLACE FUNCTION concat_locality (cocid VARCHAR)
RETURNS VARCHAR
AS
$$
...
GRANT EXECUTE ON FUNCTION concat_locality (cocid VARCHAR) TO PUBLIC;
